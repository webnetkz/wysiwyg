        ...
        <header>
            <div class="notEdit allTopNav">
				<div class="notEdit">
                    ...
                    <!-- <img src="public/img/padding.svg" onclick="showList(this);" class="notEdit elementTopNavImg">
                    <div class="showList" style="display: none">
						<div onclick="changeMarginText('1px');">1px</div>
                        <div onclick="changeMarginText('3px');">3px</div>
                        <div onclick="changeMarginText('5px');">5px</div>
                        <div onclick="changeMarginText('7px');">7px</div>
                        <div onclick="changeMarginText('10px');">10px</div>
                        <div onclick="changeMarginText('20px');">20px</div>
                        <div onclick="changeMarginText('30px');">30px</div>
					</div>
                    <img src="public/img/margin.svg" onclick="marginText();" class="notEdit elementTopNavImg"> -->
                    ...
                    <img src="public/img/formula.svg" onclick="appendFormula();" class="notEdit elementTopNavImg">	
            		</div>
